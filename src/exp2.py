...
class DialogManager:
    ...
    def variables_prepare(self):
        ...
        srcA = read_utterance("../transcripts/PRESET/BranchA.csv")
    ...
    def generate_choice_sender(self, id_list):
        sender = "<Choice>:"
        next = "Z"
    ...
    def choice_generation(self, mes):
      if "<Command>" in mes:
            ...
            t = threading.Timer(5, self.send_choice, args=[line_to_send, next_speaker])
            t.start()
    ...
    def worker_thread(self, none):
        ...
        while True:
            ...
            time.sleep(1)
            clientsocket.sendto(("<Choice>:0000,A,はじめる,よろしく").encode('utf-8'), (client_address, client_port))
